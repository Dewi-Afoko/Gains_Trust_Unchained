...
urlpatterns = [
    ...
    path("<int:workout_id>/sets/<int:set_dict_id>/", SetDictView.as_view(), name="set-detail"),

    # ✅ Action-Based Endpoints
    path("<int:workout_id>/sets/<int:set_dict_id>/complete/", complete_set, name="set-complete"),
