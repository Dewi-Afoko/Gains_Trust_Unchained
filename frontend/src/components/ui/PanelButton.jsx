...
const VARIANT_STYLES = {
    gold: {
        ...
        textGradient: 'bg-gradient-to-b from-yellow-400 via-yellow-600 to-orange-700 text-transparent bg-clip-text',
        hoverTextGradient: 'group-hover:from-white group-hover:via-gray-200 group-hover:to-gray-300',
    ...
    danger: {
        ...
        textGradient: 'bg-gradient-to-b from-white via-gray-200 to-gray-300 text-transparent bg-clip-text',
        hoverTextGradient: 'group-hover:from-yellow-400 group-hover:via-yellow-600 group-hover:to-orange-700',
