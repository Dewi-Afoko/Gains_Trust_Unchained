...
export default function WorkoutsList() {
    ...
    const filteredWorkouts = useMemo(() => {
        ...
        return workouts.filter((workout) => {
            ...
            const nameMatch = workout.workout_name
                ?.toLowerCase()
                .includes(query)
            ...
            const dateMatch = new Date(workout.date)
                .toLocaleDateString()
                .toLowerCase()
                .includes(query)
                    ...
                    >
                        <div className="space-y-4">
                                ...
                                <div className="text-sm text-gray-300 bg-black/30 rounded-lg p-3 border border-brand-gold/20">
                                    {filteredWorkouts.length === 0 ? (
                                        <span className="text-yellow-400">
                                            No workouts found matching &ldquo;
                                            {searchQuery}&rdquo;
                                        </span>
                                    ) : (
                                        <span>
                            ...
                            <div className="text-xs text-gray-400 bg-black/20 rounded-lg p-3 border border-brand-gold/10">
                                <div className="font-semibold text-brand-gold/70 mb-1 uppercase tracking-wider">
                                    Search Tips:
                                </div>
                                <ul className="space-y-1">
                                    <li>
                                        • Search by workout name: &ldquo;Upper
                                        Body&rdquo;, &ldquo;Leg Day&rdquo;
                                    </li>
                                    <li>
                                        • Search by date:
                                        &ldquo;12/25/2023&rdquo;,
                                        &ldquo;December&rdquo;,
                                        &ldquo;2023&rdquo;
                                    </li>
                                    <li>
                                        • Search by notes: &ldquo;heavy&rdquo;,
                                        &ldquo;personal record&rdquo;,
                                        &ldquo;gym&rdquo;
                                    </li>
                                </ul>
                            </div>
